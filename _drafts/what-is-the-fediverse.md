...
If you don't like your instance's moderation policies you can just migrate your account, along with all your followers and friends, to a new instance. If an instance you are on introduces advertising to raise money, you can just switch to another instance that uses a different funding model.

- Choice of application: Pixelfed vs. PeerTube vs. Mastodon
