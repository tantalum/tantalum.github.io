...
- Choice of application: Pixelfed vs. PeerTube vs. Mastodon also Choice of client
...
The Fediverse brings options and control back to the users. This also means that you as a user have the responsibility to chose what is best for you. The future direction of the Fediverse, and wither it will exist at all or not, will depend on the collective direction users, content creators, and instance admins take. I'll leave the decision of wither that is better than the direction social media has taken so up to you.
